...
import { WEBTITLE, TEL } from '../libs/front/constText';
...
const Privacy = () => {
	return (
		<Box
			...
			<Container>
				<Item elevation={3} variant='outlined'>
					<Typography p={5} align='left'>
						...
						<Typography px={8} align='justify'>
							對於本站之隱私權政策有任何疑問，或者想提出變更、移除個人資料之請求，請打服務專線{' '}
							{TEL}。
						</Typography>
					</Typography>
				</Item>
